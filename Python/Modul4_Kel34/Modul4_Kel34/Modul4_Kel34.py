...
#Pemanggilan Fungsi
non_return_func("Nuzulita setiawati", "Muhammad Dzulfiqar Rafli Anwar")
return_func(1)
anonim_func("Nuzulita setiawati", "Muhammad Dzulfiqar Rafli Anwar", 5)
arbitrary_func("Nuzulita setiawati", "Muhammad Dzulfiqar Rafli Anwar")

p1=Percobaan2.contoh_method ("Nuzulita setiawati", "Muhammad Dzulfiqar Rafli Anwar")
